...
//               { String(formRes.Height_max).length > 0 && String(formRes.Height_max).search( /^[1-9]\d*(\.\d+)?$/) === -1 && String(formRes.Height_max).length !== 0? <p>Only numbers are allowed</p>: "" }
...
//                 type="text"
//                 onChange={handleInputChange} />
//                {String(formRes.Weight_min).search( /^[1-9]\d*(\.\d+)?$/) === -1 && String(formRes.Weight_min).length > 0? <p>Only numbers are allowed</p>: "" }
//             </div>
//             <div>
